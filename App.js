        ...
        <div className="features-wrapper">
          ...
          <div className="features-slider">
            <div className="features-slider_items">
              <SlideItem
                img={{ backgroundImage: " url(./images/1.svg)" }}
                text={"Первое целевое преимущество"}
              />
              <SlideItem
                img={{ backgroundImage: " url(./images/2.svg)" }}
                text={"Второе целевое преимущество"}
              />
              <SlideItem
                img={{ backgroundImage: " url(./images/3.svg)" }}
                text={"Третье целевое преимущество"}
              />
              <SlideItem
                img={{ backgroundImage: " url(./images/4.svg)" }}
